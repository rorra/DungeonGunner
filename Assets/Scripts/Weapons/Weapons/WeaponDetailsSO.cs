...
public class WeaponDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("The sprite for the weapon - the script should have the 'generate physics shape' option selected")]
    #endregion Tooltip
    ...
    #region Tooltip
    [Tooltip("The weapon capacity - Shoots before a reload")]
    #endregion Tooltip
    ...
    #endregion Tooltip
    public float weaponPrechargeTime = 0.2f;
    #region Tooltip
    [Tooltip("Weapon reaload time in seconds")]
    #endregion Tooltip
