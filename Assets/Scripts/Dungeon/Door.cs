...
public class Door : MonoBehaviour
{
    ...
    private void Awake()
    {
        doorCollider.enabled = false; // Disabled by default
    ...
    {
        // When the player walks away from the door, the gameobject is disabled and its state is reseted.
        // We need to restore the animator state
